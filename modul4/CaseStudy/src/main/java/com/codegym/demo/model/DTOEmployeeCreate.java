...
public class DTOEmployeeCreate {
    ...
    public DTOEmployeeCreate(String employee_name, String employee_birthday, String employee_id_card, double employee_salary, String employee_phone, String employee_email, String employee_address, Position position_id, Education_degree education_degree, Division division_id, User username, String password, int role_id) {
